...
select nombre, apellido1, apellido2 from persona where tipo = 2 and telefono is null;
...
select distinct persona.nombre, persona.apellido1, persona.apellido2 from persona, alumno_se_matricula_asignatura, asignatura, grado where persona.sexo like 'M' and persona.id = alumno_se_matricula_asignatura.id_alumno and alumno_se_matricula_asignatura.id_asignatura = asignatura.id and asignatura.id_grado = grado.id and grado.nombre like 'Grado en Ingeniería Informática (Plan 2015)';
...
select persona.nombre, persona.apellido1, persona.apellido2, departamento.nombre from persona, departamento, profesor where persona.id = profesor.id_profesor and profesor.id_departamento = departamento.id and persona.tipo = 1 order by persona.apellido1, persona.apellido2, persona.nombre;
...
select departamento.nombre from departamento, profesor, asignatura, grado where departamento.id = profesor.id_departamento and profesor.id_profesor = asignatura.id_profesor and asignatura.id_grado = grado.id and grado.nombre like 'Grado en Ingeniería Informática (Plan 2015)' group by departamento.nombre;
select distinct departamento.nombre from departamento inner join profesor on departamento.id = profesor.id_departamento inner join asignatura on asignatura.id_profesor inner join grado on asignatura.id_grado = grado.id where grado.nombre like 'Grado en Ingeniería Informática (Plan 2015)' group by departamento.nombre;
...
select persona.nombre, persona.apellido1, persona.apellido2 from persona, alumno_se_matricula_asignatura, asignatura, curso_escolar where persona.tipo = 2 and persona.id = alumno_se_matricula_asignatura.id_alumno and alumno_se_matricula_asignatura.id_asignatura = asignatura.id and alumno_se_matricula_asignatura.id_curso_escolar = curso_escolar.id and curso_escolar.anyo_inicio = 2018 or curso_escolar.anyo_inicio = 2019; 
...
select persona.nombre, persona.apellido1, persona.apellido2, departamento.nombre from persona, profesor, departamento where persona.id = profesor.id_profesor and profesor.id_departamento = departamento.id order by departamento.nombre asc;

/* 8. Devuelve un listado con los profesores que no están asociados a
un departamento. */

select persona.nombre, persona.apellido1, persona.apellido2, departamento.nombre from persona, profesor, departamento where persona.id = profesor.id_profesor and profesor.id_departamento = departamento.id and departamento.id is null;
...
select departamento.nombre from departamento, asginatura, 
